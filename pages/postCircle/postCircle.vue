<template>
	<view>
		...
		<view class="circlecontent">
			<input class="circletext" type="text" placeholder="这一刻的想法..." />
		</view>
		...
		<view><u-button @click="submit" style="margin-top: 60rpx;background-color: rgb(226,62,40);color: #fff;">保存</u-button></view>
	</view>
</template>
